...
function renderTrack(): void {
    ...
    const fields: Field[] = [
        ...
        },
        {
            ...
            width: calculateDropdownWidth(["<Random>", "Firm", "Good", "Soft", "Heavy"]),
        },
        {
            key: "weather",
            label: "Weather",
            ...
            width: calculateDropdownWidth(["<Random>", "Sunny", "Cloudy", "Rainy", "Snowy"]),
        },
        {
            key: "season",
            label: "Season",
            ...
            width: calculateDropdownWidth(["<Random>", "Spring", "Summer", "Fall", "Winter", "Sakura"]),
        },
